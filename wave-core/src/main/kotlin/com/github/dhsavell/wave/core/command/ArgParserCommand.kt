...
import com.github.dhsavell.wave.core.bot.StatusColors
...
abstract class ArgParserCommand<T>(override val name: String, override val category: Category) : Command {
    abstract fun createArgsObject(parser: ArgParser, bot: WaveBot, context: IMessage): T
    abstract fun invoke(bot: WaveBot, message: IMessage, args: T): CommandResult
