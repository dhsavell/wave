...
import com.github.dhsavell.wave.core.conversation.*
import com.github.dhsavell.wave.core.util.embed
import sx.blah.discord.handle.obj.IChannel
import sx.blah.discord.handle.obj.IMessage
import sx.blah.discord.handle.obj.IUser

class PromptImpl(override val promptName: String, private val question: String,
                 private val handler: (IMessage, Map<String, String>) -> Unit,
                 private val validator: (IMessage, Map<String, String>) -> Boolean = { _, _ -> true }) : Prompt {
